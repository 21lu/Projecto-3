...
if(isset($_POST['save'])){
  ...
  $result = $database->getReference('CadastraPainel')->push($data);
  if($result){
    $_SESSION['message'] = 'Painel cadastrado com sucesso!';
  }
}
?>
<!DOCTYPE html>
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Cadastrar Painel</h4>
                        ...
                        <label
                          ...
                          <select name="lados" >
                              <option>Selecione</option>
                                <option value="Um_lado" >Um lado</option>
                                <option value="Dois_lados" >Dois lados</option>
                                <option value="Tres_lados" >Três lados</option>
                                <option value="Quatro_lados" >Quatro lados</option>
                            </select>
                      </div>
                          ...
                          <div>
                            <select name="tipo" >
                              <option>Selecione</option>
                                ...
                                <option value="frontligth">Frontlight</option>
                                <option value="backlight">Backlight</option>
                                <option value="paineis_led">Painéis de LED</option>
                                <option value="paineis_digital">Painéis Digitais</option>
                            </select>
                          ...
                          <div>
                            <select name="est" >
                              <option>Selecione</option>
                                ...
                                <option value="Por_montar">Por Montar</option>
