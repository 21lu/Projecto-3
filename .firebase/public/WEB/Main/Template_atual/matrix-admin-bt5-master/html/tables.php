        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title mb-0">Tabela Paineis</h5>
                </div>
                <table class="table">
                  <thead>
                    <tr>
                  ...
                  <?php
                    ...
                    // Referência para a tabela "CadastraPainel"
                    $ref = $database->getReference('CadastraPainel');

                    $CadastraPainel = $ref->getSnapshot()->getValue();
                        ...
                        foreach ($data as $key => $value) {
                            ...
                            echo "
                              <tr>
                                ...
                                <td>$value[est]</td>
                                <td>
                                    <a class='btn btn-primary btn-sm' href='editaPainel.php?key=$key'>Editar</a>
                                    <a class='btn btn-danger btn-sm' href='delete/deletePainel.php?key=$key'>Eliminar</a>
                                </td>
                            </tr>
                            ";
                        }
